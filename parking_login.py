...
class ParkingLogin:
    ...
    def getPromoHashId(self, authHeader, honkGuid):
        ...
        headers = {
            ...
            'cookie': '__cf_bm=UWgHCkjxGADP9e2568Df.fjWnqfdqGa9twLh3L6ZK8Y-1707316833-1-AYmwj2AJYZrVDHXasLs/iZDM0iCr0bXxPqRjVqDPxSeDTYLgdOxafKojwYJLHbKsIJUBPMo82UnYyzGG1/EfYAs='
        }
        payload = {
